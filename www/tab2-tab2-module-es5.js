  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tab2-tab2-module"], {
    ...
    function srcAppTab2Tab2ModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      Tab2PageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        imports: [_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["IonicModule"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _explore_container_explore_container_module__WEBPACK_IMPORTED_MODULE_6__["ExploreContainerComponentModule"], _tab2_routing_module__WEBPACK_IMPORTED_MODULE_7__["Tab2PageRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_8__["HttpClientModule"]],
    ...
    function srcAppTab2Tab2PageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _theMovieDB_movies_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ../theMovieDB/movies.service */
        ...
        _createClass(Tab2Page, [{
          ...
          value: function carregaPagina() {
            ...
            this.movieService.getPopularMovies(this.page, 'pt-BR').subscribe(function (data) {
              ...
              if (_this14.page == 1) {
                _this14.lista_filmes = response.results;
              } else {
                _this14.lista_filmes = _this14.lista_filmes.concat(response.results);
              }

              console.log(_this14.lista_filmes);
            }, function (error) {
              console.log(error);
            });
          }
    ...
    /***/
    function srcAppTheMovieDBMoviesServiceTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var MoviesService = /*#__PURE__*/function () {
        function MoviesService(http) {
          ...
          this.http = http;
          this.chave = "e77eb0d0fe4c05a9b6169de62a62a14f";
        ...
        _createClass(MoviesService, [{
          ...
          value: function getPopularMovies() {
            ...
            var language = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "eng";
            var filmes = "".concat(this.caminhoPadrao, "/movie/popular?page=").concat(page, "&language=").concat(language, "&api_key=").concat(this.chave);
      ...
      MoviesService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], MoviesService);
      /***/
    }
